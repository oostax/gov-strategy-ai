...
const hintsByKind: Record<TypedOutput["kind"], string[]> = {
  ...
  region: [
    "Начните с карточки региона: население, бюджет, цифровая зрелость.",
    "Отраслевая структура: какие отрасли, какие боли, что уже цифровизировано.",
    "Точки входа: привязаны к реальным проблемам региона, а не к продуктам Сбера.",
    "Информационные пробелы: чего мы не знаем — это ценнее, чем выдуманные ответы.",
  ],
};
