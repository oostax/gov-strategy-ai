...
export const taskTypes = [
  ...
  "sber_region_strategy", // 1-2 раза/мес — стратегия Сбера в регионе (портфель + план действий)
  "region_strategy",      // 1-2 раза/мес — анализ региона: бюджет, отрасли, приоритеты, сценарии
...
export const taskOutputDescription: Record<TaskType, string> = {
  ...
  region_strategy:     "Бюджет · отрасли · приоритеты · ЛПР · сценарии",
...
export const taskWhenToUse: Record<TaskType, string> = {
  ...
  region_strategy:     "Понять регион до встречи или управленческого решения",
...
export const taskFocusPlaceholder: Record<TaskType, string> = {
  ...
  region_strategy:
    "Например: нужен анализ Татарстана — бюджет, отрасли, приоритеты на 5 лет, ЛПР, поставщики и сценарии",
  strategic_bets:
